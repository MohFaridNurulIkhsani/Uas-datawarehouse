...
$querylihat="SELECT id_nilaicustomer,kriteria.namaKriteria AS namaKriteria,nilai_kriteria.keterangan AS keterangan FROM nilai_customer
INNER JOIN kriteria USING (id_kriteria)
INNER JOIN nilai_kriteria USING (id_nilaikriteria)
WHERE nilai_customer.id_customer='$a' AND nilai_customer.id_jenisbarang='$b'";
