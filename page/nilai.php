...
<div class="panel" style="background-color:#92B8CA">
    <div class="panel-middle" id="judul">
        <img src="asset/image/hasil.png" style="weight: 30px;height:30px;">
        <div id="judul-text">
            <h2 style="color:#000000">PENILAIAN</h2>
        ...
        <div class="panel">
            ...
            <div class="panel-middle" id="animation">
                <div class="table-responsive">
                    <table>
                        <thead><tr><th>No</th><th>Nama Barang</th><th>Nama customer</th><th>Aksi</th></tr></thead>
