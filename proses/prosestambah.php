...
switch ($op){
    ...
    break;
    case 'customer': //tambah data customer
        $query="INSERT INTO customer (namacustomer) VALUES ('$customer')";
        $crud->addData($query,$konek);
    break;
    ...
    case 'nilai'://tambah data nilai
        ...
        for ($i=0;$i<count($nilai);$i++){
            $query.="INSERT INTO nilai_customer (id_customer,id_jenisbarang,id_kriteria,id_nilaikriteria) VALUES ('$customer','$barang','$kriteria[$i]','$nilai[$i]');";
        }
        $crud->multiAddData($cek,$query,$konek);
    break;
}